...
public abstract class List {
  ...
  //@param the node that we are checking to see if it is in this list
  //@return whether or not the ListNode d is inside this list
  public boolean inList(ListNode d) throws InvalidNodeException{
